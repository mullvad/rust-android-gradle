...
data class TargetTestData(val target: String, val location: String) : WithDataTestName {
    override fun dataTestName() = "cargoBuild produces $location for target $target"
}
    ...
    FunSpec(
        {
            ...
            val test: suspend FunSpecContainerScope.(TargetTestData) -> Unit =
                { (target, location) ->
                    // arrange
