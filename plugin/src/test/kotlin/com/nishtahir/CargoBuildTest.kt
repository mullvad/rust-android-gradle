...
data class BuildTestData(val android: VersionNumber, val gradle: GradleVersion) : WithDataTestName {
    override fun dataTestName() = "cargoBuild is invoked with $gradle and Android plugin $android"
}
